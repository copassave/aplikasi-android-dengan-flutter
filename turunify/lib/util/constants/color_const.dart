...
class ColorConst {
  ...
  static const Color lightPrimaryColor = Color(0xFF130613);
  static const Color lightAccentColor = Color(0xFF130613);
  static const Color lightFocusColor = Color(0xFF130613);
  static const Color lightShadowColor = Color(0xFFEDEEFA);

  static const Color lightCanvasColor = Color(0xFF130613);
  static const Color lightBottomAppBar = Color(0xFFFFFFFF);
  static const Color lightBackgroundColor = Color(0xFFFFFFFF);

  static const Color lightPrimaryTextColor = Color(0xFF000000);
  static const Color lightSecondaryTextColor = Color(0xFFA0AEC5);

  static const Color darkPrimaryColor = Color(0xFF212326);
  static const Color darkAccentColor = Color(0xFF130613);
