...
import 'package:turunify/util/constants/color_const.dart';
...
class _SmallWeightChartWidgetState extends State<SmallWeightChartWidget> {
  List<Color> lineColors = [Color(0xFF130613).withOpacity(0.8)];
  List<Color> underBarColors = [Color(0xFF130613).withOpacity(0.1)];
  List<int> dashLine = [5];
